...
/**
 * Phase 2 step 5 gallery host: viewport bind loads with display-sized decode plus a
 * bounded {@link ThumbnailCache}; executor and cache are torn down on destroy.
 */
